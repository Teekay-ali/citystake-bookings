...
Route::middleware(['auth', EnsureUserIsStaff::class])->prefix('manage')->name('manage.')->group(function () {
    ...
    Route::post('/bookings/{booking}/resume', [AdminBookingController::class, 'resumeBooking'])->name('bookings.resume');
    ...
    Route::post('/bookings/{booking}/record-payment', [AdminBookingController::class, 'recordPayment'])->name('bookings.record-payment');
