        ...
        <div class="min-h-screen bg-white dark:bg-gray-950">
            <div class="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                ...
                <div v-if="isLoading" class="animate-pulse">
                    <!-- Header Skeleton -->
                    <div class="mb-16">
                        <div class="h-12 bg-gray-200 dark:bg-gray-800 rounded w-1/3 mb-4"></div>
                        <div class="h-6 bg-gray-200 dark:bg-gray-800 rounded w-1/4"></div>
                    </div>

                    <!-- Filters Skeleton -->
                    <div class="flex flex-wrap items-center gap-3 mb-8">
                        <div class="h-12 bg-gray-200 dark:bg-gray-800 rounded-full w-40"></div>
                        <div class="h-12 bg-gray-200 dark:bg-gray-800 rounded-full w-36"></div>
                        <div class="h-12 bg-gray-200 dark:bg-gray-800 rounded-full w-32"></div>
                        <div class="h-12 bg-gray-200 dark:bg-gray-800 rounded-full w-44"></div>
                    </div>
