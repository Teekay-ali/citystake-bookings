    ...
    <AppLayout :hide-footer="true">
        ...
        <div class="bg-white dark:bg-gray-950 min-h-screen py-16">
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                ...
                <!-- Countdown Alert -->
                <div v-if="daysUntilCheckIn > 0 && daysUntilCheckIn <= 7 && booking.status !== 'cancelled'" class="mb-8 no-print">
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-4">
                        <div class="flex items-center">
                            <Clock class="w-5 h-5 text-blue-600 dark:text-blue-400 mr-3" />
                            <div>
                                ...
                                <p class="text-xs text-blue-700 dark:text-blue-400 mt-0.5">
                                    Remember to contact the property 24 hours before arrival
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <div class="p-6 flex-1">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 flex items-center mb-4">
                                        ...
                                        {{ booking.building.name }} • {{ booking.building.city }}
                                    </p>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <Link
                                            ...
                                            class="inline-flex items-center px-3 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white text-xs font-medium rounded-lg transition-all"
                                        >
                                            <HomeIcon class="w-3.5 h-3.5 mr-1.5" />
                                            View Property
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div class="border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Stay Details</h3>
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center">
                                        <Calendar class="w-3.5 h-3.5 mr-1" /> Check-in
                                    </p>
                                    <p class="text-base font-medium text-gray-900 dark:text-white">{{ formatDate(booking.check_in) }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">After 2:00 PM</p>
                                </div>
                                <div>
                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center">
                                        <Calendar class="w-3.5 h-3.5 mr-1" /> Check-out
                                    </p>
                                    <p class="text-base font-medium text-gray-900 dark:text-white">{{ formatDate(booking.check_out) }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Before 12:00 PM</p>
                                </div>
                            </div>
                            <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-900">
                                <div class="grid grid-cols-2 gap-6">
                                    <div>
                                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Duration</p>
                                        <p class="text-sm text-gray-900 dark:text-white">{{ booking.nights }} night{{ booking.nights > 1 ? "s" : "" }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center">
                                            <Users class="w-3.5 h-3.5 mr-1" /> Guests
                                        </p>
                                        <p class="text-sm text-gray-900 dark:text-white">{{ booking.guests }} guest{{ booking.guests > 1 ? "s" : "" }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-900">
                                <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Unit Assignment</p>
                        ...
                        <!-- Guest Information -->
                        <div class="border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Guest Information</h3>
                            <div class="space-y-3 text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <a :href="`mailto:${booking.guest_email}`" class="font-medium text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">
                                        {{ booking.guest_email }}
                                    </a>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Phone</span>
                                    <a :href="`tel:${booking.guest_phone}`" class="font-medium text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">
                                        {{ booking.guest_phone }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <!-- ── Message Thread ── -->
                        <div class="border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden no-print">
                            <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center gap-2">
                                ...
                                <span class="text-xs text-gray-400 dark:text-gray-500 ml-auto">Communicate with the property team</span>
                            </div>

                            <!-- Thread -->
                            <div class="divide-y divide-gray-50 dark:divide-gray-800/50 max-h-96 overflow-y-auto">
                                <div v-if="!booking.messages?.length" class="px-6 py-10 text-center">
                                    <MessageSquare class="w-8 h-8 text-gray-200 dark:text-gray-700 mx-auto mb-2" />
                                    <p class="text-sm text-gray-400 dark:text-gray-500">
                                        No messages yet. Send a message to the property team below.
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    <div class="flex items-center gap-2 mb-1.5">
                                        <span
                                            ...
                                            :class="msg.sender_type === 'guest' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'"
                                        >
                                            {{ msg.sender_type === 'guest' ? 'You' : 'Property Team' }}
                                        </span>
                            ...
                            <!-- Input -->
                            <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950">
                        ...
                        <div class="border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                            ...
                            <div class="pt-4 border-t border-gray-200 dark:border-gray-800">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    Status:
                                    <span
                                        :class="booking.payment_status === 'paid' ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400'"
                                        class="font-medium"
                                    >
                ...
                <div class="print-receipt">
                    <div class="mb-6 pb-4 border-b border-gray-300">
                        ...
                        <p class="text-xs text-gray-600 mt-1">
                            Booked on {{ new Date(booking.created_at).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" }) }}
                        </p>
                    </div>
                    ...
                    <div class="mb-6 pb-4 border-b border-gray-300">
                        ...
                        <p class="text-xs text-gray-600 mt-2">
                            Payment Status: <span class="font-medium text-green-600">{{ booking.payment_status }}</span>
                        </p>
                    </div>
                ...
                <div class="print-only text-center mb-8">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-300">
                        <h2 class="text-xl font-semibold text-gray-900">Booking Receipt</h2>
                    </div>
                </div>
