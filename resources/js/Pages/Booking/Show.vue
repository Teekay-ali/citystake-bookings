            ...
            <div class="max-w-5xl mx-auto px-6 lg:px-8">
                        ...
                        <div class="border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                            ...
                            <div class="pt-4 border-t border-gray-200 dark:border-gray-800">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    Status: <span :class="booking.payment_status === 'paid' ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400'" class="font-medium">
                ...
                <div class="print-receipt">
                    ...
                    <div class="mb-6 pb-4 border-b border-gray-300">
                        ...
                        <p class="text-xs text-gray-600 mt-2">Payment Status: <span class="font-medium text-green-600">{{ booking.payment_status }}</span></p>
                    </div>
